    ...
    <div class="">
        <section class=" flex justify-center items-center ml-[240px] pt-[80px] h-screen">
            <div class="bg-white w-[750px] h-[550px]">
                <h1 class="text-center font-extrabold text-[#EE6C4D] pb-8 pt-4 text-2xl">REGISTRATION</h1>
                <form action="" class="flex justify-center relative">
                            ...
                            <div class="pl-3 mb-4">
                                ...
                                <div class="flex justify-between gap-3">
                                    <div class=" gap-2">
                                        ...
                                        <div><input type="text" name="owner_name" class="bg-gray-200 w-[300px]">
                                        </div>
                                    </div>
                                    <div class=" gap-2">
                            ...
                            <div class="pl-3 mb-4">
                                <div class="flex gap-14">
                                    <div class="gap-2 w-[300px]">
                                        ...
                                        <div><input type="file" name="fileToUpload" id="fileToUpload"
                                                class="">
                                        </div>
                                    </div>
                                    <div class="gap-2 w-[300px]">
                            ...
                            <div class="pl-3 mb-4">
                                <div class="flex gap-14">
                                    <div class="gap-2 w-[300px]">
                                        ...
                                        <select name="" id="" class="bg-gray-200 gap-3">
                                            <option value="">COW</option>
                                            <option value="">GOAT</option>
                                            <option value="">HORSE</option>
                                            <option value="">SWINE</option>
                                            <option value="">CARABAO</option>
                                        </select>
                                    </div>
                                    <div>
                                        <div><label for="">Butcher</label></div>
                                        <select name="" id="" class="bg-gray-200 gap-3 [300px]">
                            ...
                            <div class="pl-3 mb-4">
                                ...
                                <div class="flex justify-between gap-3">
                                    ...
                                    <div class=" gap-2 w-[300px]">
                                        ...
                                        <select name="" id="" class="bg-gray-200 gap-3 [300px]">
                                            <option value="">Wet Market</option>
                                            <option value="">Meat Shops</option>
                                            <option value="">Meat Cutting</option>
                                            <option value="">Hotel and Restaurants</option>
                                            <option value="">Super Market</option>
                                            <option value="">Meat Processing Plant</option>
                                            <option value="">Cold Storage</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex justify-between">
                                    <div class="flex">
                                        <div class="pl-3">
                                            ...
                                            <div><select name="" id="" class="bg-gray-200 gap-3">
                                        ...
                                        <div class="pl-3">
                                            ...
                                            <div><input type="number" name="age" class="bg-gray-200 w-12  ">
                                            </div>
                                        </div>
                                        <div class="pl-3">
                                            <div><label for="">Live Weight</label></div>
                                            <div><input type="number" name="live_weight" class="bg-gray-200 w-24">
                                            </div>
                                        </div>
