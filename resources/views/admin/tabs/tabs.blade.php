<div class=" rounded-xl p-4 hidden lg:block">
    <ul class="flex flex-wrap -mb-px text-sm font-semibold text-center text-gray-400 ">
...
{{-- <ul class="flex space-x-2">
    <li class="me-2">
        <a href="{{ route('admin.schedule.list') }}"
            class="group text-black {{ request()->is('admin/schedule*') ? 'text-blue-500' : '' }}">
            <!-- Add your icon and text content here -->
            Schedule
        </a>
    </li>
    <li class="me-2">
        <a href="{{ route('admin.for.slaughter.list') }}"
            class="group text-black {{ request()->is('admin/for/slaughter*') ? 'text-blue-500' : '' }}">
            <!-- Add your icon and text content here -->
            For Slaughter
        </a>
    </li>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tabLinks.forEach(function(link) {
            ...
            if (link.getAttribute('href') === currentPageUrl) {
                ...
                link.classList.add('border-blue-600', 'text-[#38419D]',
