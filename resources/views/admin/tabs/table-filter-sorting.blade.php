<div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 pb-2 px-4">
    ...
    <div
        ...
        <div class="flex items-center space-x-3 w-full md:w-auto">
            <button id="sortDropdownBtn" data-dropdown-toggle="sortDropdown"
            ...
            <div id="sortDropdown"
                ...
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="sortDropdownBtn">
                    <li>
                        <a href="#"
