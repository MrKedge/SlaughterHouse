        ...
        <div class="font-semibold text-[20px]">
            <form class="" action="">
                <div class="flex justify-center p-2">
                    ...
                    <div><input type="text" class="rounded-[20px] bg-gray-200"></div>
                </div>
                <div class="flex justify-center p-2">
                    <div class=" text-center mr-1"><label for="">Last Name</label></div>
                    <div><input type="text" class="rounded-[25px] bg-gray-200"></div>
                </div>
                ...
                <div class="flex justify-center p-2">
                    <div class="w-[100px]"><label for="email" class="text-centers">Email</label></div>
                    <div><input type="email" class="rounded-[25px] bg-gray-200"></div>
                </div>
                <div class="flex justify-center p-2">
                    <div class="w-[100px]"><label for="password" class="text-centers">Password</label></div>
                    <div><input type="password" class="rounded-[25px] bg-gray-200"></div>
                </div>
                <div class="flex justify-center p-2">
