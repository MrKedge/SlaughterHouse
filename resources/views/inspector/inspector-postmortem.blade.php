                        ...
                        @forelse ($animal as $animals)
                            <tbody>
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        {{ \Carbon\Carbon::parse(optional($animals->postMortem)->slaughtered_at)->format('M d Y') }}
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ \Carbon\Carbon::parse(optional($animals->postMortem)->slaughtered_at)->format('h:i a') }}
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $animals->butcher }}
                                    </td>
