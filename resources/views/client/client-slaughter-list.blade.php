...
@include('layout.html-head', ['pageTitle' => 'Slaughter List'])
            ...
            <div class="flex flex-col w-full ">
                ...
                <div class="mx-auto w-full">
                    ...
                    <section
                        ...
                        <h1 class="text-2xl font-bold py-3 text-[#293241]">Slaughtered</h1>
                                    ...
                                    @if ($animal->isEmpty())
                                        <tr>
                                            <td colspan="5" class="py-4 border-b border-black text-center">
                                                <h1 class="font-bold italic pb-3">No Slaughter Animal</h1>
                                    ...
                                    @else
                                        @foreach ($animal as $animals)
                                            <tr
                                                ...
                                                <td class="py-4 border-b border-black uppercase font-medium">
                                                    {{ $animals->status }}
                                                </td>
